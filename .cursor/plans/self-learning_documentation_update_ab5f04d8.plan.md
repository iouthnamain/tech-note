---
name: Self-Learning Documentation Update
overview: Transform the existing documentation into comprehensive self-learning guides with practical coding examples, step-by-step exercises, external references, and clear learning paths for individual study.
todos:
  - id: analyze-structure
    content: Analyze current document structure and identify enhancement points
    status: completed
  - id: update-overview
    content: Update FULL-STACK LEVEL JUNIOR.md with self-learning roadmap, time estimates, and prerequisites
    status: completed
    dependencies:
      - analyze-structure
  - id: create-folder-structure
    content: Create folder structure with 17 group folders and 250+ topic folders
    status: pending
    dependencies:
      - analyze-structure
  - id: migrate-content
    content: Migrate topic content from NOI_DUNG_KHOA_HOC_CHI_TIET.md to individual topic README.md files
    status: pending
    dependencies:
      - create-folder-structure
  - id: add-code-examples
    content: Add code examples to topic folders (examples/ subfolders) for Group 1 topics first (15 topics), then expand to other groups
    status: completed
    dependencies:
      - migrate-content
  - id: create-exercises
    content: Create exercise files in exercises/ subfolders for Group 1 topics first (all 15 topics), then expand to Groups 2-3, and master PRACTICE_EXERCISES.md index
    status: completed
    dependencies:
      - add-code-examples
  - id: add-resources
    content: Create RESOURCES.md with external links, tutorials, and tools for each topic group
    status: completed
    dependencies:
      - analyze-structure
  - id: create-assessment
    content: Create SELF_ASSESSMENT.md with progress tracker and knowledge checks
    status: pending
    dependencies:
      - analyze-structure
  - id: add-projects
    content: Add practice project suggestions to overview document
    status: pending
    dependencies:
      - create-exercises
  - id: bilingual-support
    content: Add English translations for key sections and technical terms
    status: completed
    dependencies:
      - update-overview
      - add-code-examples
