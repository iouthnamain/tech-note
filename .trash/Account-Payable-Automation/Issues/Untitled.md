...
- [x] Testing performed (unit, integration, UAT as relevant)
- [x] Security/performance impacts considered (if applicable)
- [x] Issue confirmed resolved by reporter/stakeholder
- [x] No new regressions observed/monitored
