# Group 11: Agile vs Waterfall - Mastering Scrum / NHÓM 11: Agile vs Waterfall - Thành thạo Scrum

## Overview / Tổng quan

**English**: This group covers Agile methodologies, Scrum framework, and comparison with Waterfall. Learn to work effectively in Agile teams, participate in Scrum ceremonies, and understand Agile principles.
...
3. [11.03 Sprint Planning](./11.03_Sprint_Planning.md) - Plan sprints
4. [11.04 Daily Standup](./11.04_Daily_Standup.md) - Daily meetings
5. [11.05 Sprint Review](./11.05_Sprint_Review.md) - Review sprints
6. [11.06 Sprint Retrospective](./11.06_Sprint_Retrospective.md) - Reflect and improve
7. [11.07 User Stories](./11.07_User_Stories.md) - Write user stories
8. [11.08 Story Points](./11.08_Story_Points.md) - Estimate with points
9. [11.09 Product Backlog](./11.09_Product_Backlog.md) - Manage backlog
10. [11.10 Sprint Backlog](./11.10_Sprint_Backlog.md) - Sprint tasks
11. [11.11 Burndown Charts](./11.11_Burndown_Charts.md) - Track progress
12. [11.12 Velocity](./11.12_Velocity.md) - Measure velocity
