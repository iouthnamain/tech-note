...
1. Vẽ lại mental model cho bài “Debounce và Throttle” bằng một sơ đồ của riêng bạn và giải thích lại bằng ngôn ngữ đời thường.
2. Tạo một demo nhỏ hoặc một đoạn code ngắn thể hiện rõ hành vi cốt lõi của “Debounce và Throttle” trong bối cảnh một listing/search experience cần nhanh dưới tải tương tác liên tục.
3. Cố tình tạo một bug hoặc một hiểu lầm phổ biến liên quan đến “Debounce và Throttle”, sau đó viết cách bạn sẽ debug nó từng bước.
4. Viết một ghi chú system-design ngắn: nếu áp dụng “Debounce và Throttle” vào một listing/search experience cần nhanh dưới tải tương tác liên tục, quyết định kiến trúc nào sẽ bị ảnh hưởng nhiều nhất?
