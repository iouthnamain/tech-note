...
1. Vẽ lại mental model cho bài “Cơ Bản Kiến Trúc và Internals của React” bằng một sơ đồ của riêng bạn và giải thích lại bằng ngôn ngữ đời thường.
2. Tạo một demo nhỏ hoặc một đoạn code ngắn thể hiện rõ hành vi cốt lõi của “Cơ Bản Kiến Trúc và Internals của React” trong bối cảnh một mini app mô phỏng browser/runtime và render flow.
3. Cố tình tạo một bug hoặc một hiểu lầm phổ biến liên quan đến “Cơ Bản Kiến Trúc và Internals của React”, sau đó viết cách bạn sẽ debug nó từng bước.
4. Viết một ghi chú system-design ngắn: nếu áp dụng “Cơ Bản Kiến Trúc và Internals của React” vào một mini app mô phỏng browser/runtime và render flow, quyết định kiến trúc nào sẽ bị ảnh hưởng nhiều nhất?
