...
1. Vẽ lại mental model cho bài “Navigation, Loading, Error và Not Found” bằng một sơ đồ của riêng bạn và giải thích lại bằng ngôn ngữ đời thường.
2. Tạo một demo nhỏ hoặc một đoạn code ngắn thể hiện rõ hành vi cốt lõi của “Navigation, Loading, Error và Not Found” trong bối cảnh một Next.js dashboard shell cho SaaS product.
3. Cố tình tạo một bug hoặc một hiểu lầm phổ biến liên quan đến “Navigation, Loading, Error và Not Found”, sau đó viết cách bạn sẽ debug nó từng bước.
4. Viết một ghi chú system-design ngắn: nếu áp dụng “Navigation, Loading, Error và Not Found” vào một Next.js dashboard shell cho SaaS product, quyết định kiến trúc nào sẽ bị ảnh hưởng nhiều nhất?
