...
1. Tích hợp nội dung của bài “React Query: Fetching” vào một vertical slice nhỏ trong một workspace dashboard có server state, mutations và cache rõ ràng.
2. Liệt kê 3 failure modes hoặc implementation mistakes có thể xảy ra khi dùng “React Query: Fetching”, kèm cách phát hiện sớm.
3. Viết một decision note: vì sao “React Query: Fetching” nên được đặt ở boundary này thay vì boundary khác trong một workspace dashboard có server state, mutations và cache rõ ràng?
4. Xác định một cách đo hoặc kiểm chứng để biết việc áp dụng “React Query: Fetching” đang mang lại lợi ích thật.
