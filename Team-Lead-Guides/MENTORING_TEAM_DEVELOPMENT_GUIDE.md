...
```mermaid
flowchart LR
    Mentoring[Mentoring<br/>Long-term<br/>Career-focused<br/>Relationship] --> Different
    Coaching[Coaching<br/>Short-term<br/>Skill-focused<br/>Task-oriented] --> Different
    Training[Training<br/>Structured<br/>Knowledge transfer<br/>Formal] --> Different
    
    style Mentoring fill:#e1f5ff
    style Coaching fill:#fff4e6
...
```mermaid
flowchart TD
    Establish[Establish Relationship] --> Assess[Assess Needs]
    Assess --> Plan[Create Development Plan]
    Plan --> Execute[Execute Plan]
    Execute --> Review[Review Progress]
    Review --> Adjust[Adjust Plan]
    Adjust --> Execute
    Review --> Complete[Complete Goals]
    
    style Establish fill:#e1f5ff
...
```mermaid
flowchart TD
    Identify[Identify Need] --> Plan[Plan Workshop]
    Plan --> Prepare[Prepare Materials]
    Prepare --> Schedule[Schedule Session]
    Schedule --> Conduct[Conduct Workshop]
    Conduct --> FollowUp[Follow Up]
    FollowUp --> Evaluate[Evaluate Effectiveness]
    
    style Identify fill:#e1f5ff
    style Conduct fill:#fff4e6
...
```mermaid
flowchart TD
    Assess[Assess Current State] --> Goals[Define Goals]
    Goals --> Gap[Identify Gaps]
    Gap --> Plan[Create Plan]
    Plan --> Execute[Execute Plan]
    Execute --> Review[Review Progress]
    Review --> Adjust[Adjust Plan]
